...
Private Sub Form_Load()
    ...
    Retval = PlaySound(App.Path & "\sfx\Kaeidzuka ~ Higan Retour.wav", 0, 1 Or 8)
        ...
        If Img_GC(kChk).Top >= 5520 Then
            If Img_GC(kChk).Left + Img_GC(kChk).Width >= Img_SpL.Left + 120 Then
                If Img_GC(kChk).Left <= Img_SpL.Left + 1080 Then
                    ...
                    'Retval = PlaySound(App.Path & "\sfx\coin.wav", 0, 1)
                    score = score + 515
                End If
            End If
        End If
        ...
        If Img_Gbl(kChk).Top >= 5280 Then
            If Img_Gbl(kChk).Left + Img_Gbl(kChk).Width >= Img_SpL.Left + 120 Then
                If Img_Gbl(kChk).Left <= Img_SpL.Left + 1080 Then
                    ...
                    'Retval = PlaySound(App.Path & "\sfx\oof.wav", 0, 1)
                    life = life - 1
                End If
            End If
        End If
...
Private Sub Cmd_start_Click()
    ...
    Retval = PlaySound(App.Path & "\sfx\Mound of Life.wav", 0, 1 Or 8)
